...
def load_credit_data(file_path):
    ...
    # data = pd.read_excel(join(sk_data_dir, archive.filename), sheetname='Data', header=1)
    data = pd.read_excel(file_path, sheet_name='Data', header=1)
